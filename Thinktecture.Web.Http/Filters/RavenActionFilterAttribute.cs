...
using Thinktecture.Web.Http.RavenDb;
...
namespace Thinktecture.Web.Http.Filters {
	...
	public class RavenActionFilterAttribute : ActionFilterAttribute {
		...
		public override void OnActionExecuting(HttpActionContext filterContext) {
			DocumentStoreHolder.Url = null != _uri ? _uri : null;
			DocumentStoreHolder.ConnectionStringName = !string.IsNullOrEmpty(_connectionStringName)
														? _connectionStringName
														: null;
			filterContext.Request.Properties["RavenDocumentStore"] = DocumentStoreHolder.TryAddSession(filterContext.ControllerContext.Controller);
		}
